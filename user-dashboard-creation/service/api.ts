...
import { AuthResponse, CocineroDto, CreateDescriptionDto, CreateIntervencionDto, createProfesionalDTO, DescriptionDto, EditCocineroDto, EditDescriptionDto, EditEmpleadoDto, EditIntervencionDto, EditMantenimientoDto, EditNutricionistaDto, EditProfesionalDTO, EditTecnicoDto, EditUserDto, EmailDto, GeneralResponse, IntervencionDto, MantenimientoDto, MenuDiaDto, NutricionistaDto, NutricionSemanalDto, SaveMantenimientoDto, TecnicoDto, User } from '@/lib/types';
...
export const profesionalApi = {
  ...
  validateResetToken: async (token: string): Promise<void> => {
    return apiCall<void>(`/password/validate-token/${token}`, {
      method: "GET",
    });
  },
  /////////////////INTERVENCIONES/////////////////////
...
export const AdminApi = {
  ...
  editTecnico: async (tecnicoId: string, tecnico: EditTecnicoDto): Promise<GeneralResponse> => {
    return apiCall<GeneralResponse>(`/admin/edit-tecnico/${tecnicoId}`, {
      method: "PUT",
      body: JSON.stringify(tecnico)
    })
  },

  editProfesional: async (profesionalId: string, profesional: EditProfesionalDTO): Promise<GeneralResponse> => {
    return apiCall<GeneralResponse>(`/admin/edit-profesional/${profesionalId}`, {
      method: "PUT",
      body: JSON.stringify(profesional)
    })
  },

  editNutricionista: async (nutricionistaId: string, nutricionista: EditNutricionistaDto): Promise<GeneralResponse> => {
    return apiCall<GeneralResponse>(`/admin/edit-nutricionista/${nutricionistaId}`, {
      method: "PUT",
      body: JSON.stringify(nutricionista)
    })
  },

  editCocinero: async (cocineroId: string, cocinero: EditCocineroDto): Promise<GeneralResponse> => {
    return apiCall<GeneralResponse>(`/admin/edit-cocinero/${cocineroId}`, {
      method: "PUT",
      body: JSON.stringify(cocinero)
    })
  },

  editEmpleado: async (empleadoId: string, empleado: EditEmpleadoDto): Promise<GeneralResponse> => {
    return apiCall<GeneralResponse>(`/admin/edit-empleado/${empleadoId}`, {
      method: "PUT",
...
export const NutricionistaApi = {
  ...
  getDescriptions: async (desde: string, hasta: string, page: number, size: number): Promise<any> => {
    ...
    return apiCall<any>(`/nutricionista/descriptions?${query}`, {
      method: "GET"
    });
  },

  getMyDescriptions: async (
    desde: string = "",
    hasta: string = "",
    page: number = 0,
    size: number = 8
  ): Promise<any> => {
    // Utilizamos URLSearchParams para construir la URL de forma limpia y segura
    const params = new URLSearchParams({
      page: page.toString(),
      size: size.toString(),
      desde: desde,
    ...
    return apiCall<any>(`/nutricionista/myDescriptions?${params.toString()}`, {
      method: "GET"
    });
  },

  createDescription: async (description: CreateDescriptionDto): Promise<GeneralResponse> => {
    return apiCall<GeneralResponse>(`/nutricionista/create-description`, {
      method: "POST",
      body: JSON.stringify(description)
    })
  },

  editDescription: async (descriptionId: string, description: EditDescriptionDto): Promise<GeneralResponse> => {
    return apiCall<GeneralResponse>(`/nutricionista/edit-description/${descriptionId}`, {
      method: "PUT",
      body: JSON.stringify(description)
    })
  },

  deleteDescription: async (userId: string): Promise<GeneralResponse> => {
    return apiCall<GeneralResponse>(`/nutricionista/${userId}`, {
      method: "DELETE"
    })
  },
...
export const TecnicoApi = {
  ...
  getTecnicos: async (): Promise<TecnicoDto[]> => {
    return apiCall<TecnicoDto[]>(`/tecnico`, {
      method: "GET"
    });
  },

  getTecnico: async (tecnicoId: string): Promise<TecnicoDto> => {
    return apiCall<TecnicoDto>(`/tecnico/${tecnicoId}`, {
      method: "GET"
    })
  },
  ...
  getDescriptions: async (desde: string, hasta: string, page: number, size: number): Promise<any> => {
    ...
    return apiCall<any>(`/tecnico/descriptions?${query}`, {
      method: "GET"
    });
  },
  ...
  getMyDescriptions: async (
    ...
    return apiCall<any>(`/tecnico/myDescriptions?${params.toString()}`, {
      method: "GET"
    });
  },

  createDescription: async (description: CreateDescriptionDto): Promise<GeneralResponse> => {
    return apiCall<GeneralResponse>(`/tecnico/create-description`, {
      method: "POST",
      body: JSON.stringify(description)
    })
  },
  ...
  editDescription: async (descriptionId: string, description: EditDescriptionDto): Promise<GeneralResponse> => {
    return apiCall<GeneralResponse>(`/tecnico/edit-description/${descriptionId}`, {
      method: "PUT",
      body: JSON.stringify(description)
    })
  },
  ...
  deleteDescription: async (userId: string): Promise<GeneralResponse> => {
    return apiCall<GeneralResponse>(`/tecnico/${userId}`, {
      method: "DELETE"
    })
  },
