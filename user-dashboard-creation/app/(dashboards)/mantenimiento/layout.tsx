...
import { MantenimientoHeader } from "@/components/mantenimiento/mantenimiento-header";
...
export default function MantenimientoLayout({
  ...
  if (user?.role !== "MANTENIMIENTO") {
    return (
      <div className="min-h-screen flex flex-col items-center justify-center gap-4">
        ...
        <p className="text-muted-foreground">No tienes permisos para acceder al panel de mantenimiento.</p>
        <button 
          onClick={() => router.push("/")}
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <MantenimientoHeader userName={`${user.username}`} />
